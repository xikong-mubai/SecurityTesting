...
namespace test
{
    public class Hash_IDEA
    {
        ...
        /// 最后修改日期：$time$ 
        /// </summary>
        public static int FindMODreverse(int a, int m)
        {
            int m_tmp = m, q;
            int x_1 = 1, x_2 = 0;
            int y_1 = 0, y_2 = 1;
            ...
            while (x_1 < 0) x_1 += m_tmp;
            while (x_1 >= m_tmp) x_1 -= m_tmp;
            return x_1;
        }
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("{0}",tmp[0]);
            Array.Reverse(tmp);
            test = '0' + new string(tmp);
            Console.WriteLine("{0}", test);
            Console.WriteLine("{0}",Hash_IDEA.ROL("00011",3));
            Console.WriteLine("{0:x8}",Hash_IDEA.IDEA_Crypto("1234567887654321", "1234567887654321"));
        }
    }
}
